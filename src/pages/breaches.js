              ...
              <CardContent>
                ...
                <h6
                  dangerouslySetInnerHTML={{
                    __html: each_breach["Description"],
                  }}
                ></h6>

                <h6>
                  <i className="ssm">Breach Date:</i>{" "}
                  {each_breach["BreachDate"]}
                </h6>

                <h6>
                  <i className="ssm">Compromised Data Classes:</i>
                  <br /> <br />
                  {each_breach["DataClasses"].map((each) => {
                    return <h6>{each}</h6>;
                  })}
                </h6>
              </CardContent>
